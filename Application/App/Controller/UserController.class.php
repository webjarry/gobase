...
//        $this->param = $param;
    ...
    public function yepay(){
        ...
        if($money>$balance){
            ...
            if ($jian) {
                ...
                } elseif ($order['type'] == 2 || $order['type'] == 3 || $order['type'] == 4 || $order['type'] == 5 || $order['type'] == 6 || $order['type'] == 7  || $order['type'] == 100) {
					$water = array(
						'uid'=>$order['uid'],
						'type'=>2,
						'user_type'=>$order['utype'],
    ...
    public function uaskorder(){
        ...
        foreach($result as $k=>$v){
            ...
            $result[$k][ordertype]= ordertype($v['type'],$v['service_id']);
    ...
    public function chakan(){
        ...
        if($post[type]==2){
			...
			$a['otype'] = ordertype($a[type],$a['service_id']);
			if($a['type'] == 3){
				$a[aj]=M('ajcate')->find($a[ajid])[name];
    ...
    public function saskorder(){
        ...
        if($post[type]>0){
			...
			if($post[type] >= 10){
				$where['service_id']=array('eq',$post[type]);
